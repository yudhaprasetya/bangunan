...
if (!empty($_REQUEST['tanggal'])) {
  ...
  COUNT(CASE WHEN waktu LIKE '$sab_format%' THEN b.ket_hadir END) hdsabtu FROM tukang AS a LEFT JOIN absen_tukang AS b ON a.nama_karyawan=b.nama_karyawan GROUP BY nama_karyawan, jabatan, upah ORDER BY a.nama_karyawan";
